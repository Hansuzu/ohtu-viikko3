...
public class KassapaateTest {
    ...
    @Test
    public void lataaMatkakortilleTasmalleenOikeanSummanRahaaKunAnnettuSummaPositiivinen() {
        kassa.lataa(kortti, 123);
        verify(kortti, times(1)).lataa(eq(123));
    }
    
    @Test
    public void alaLataaMatkakortilleRahaaSilloinKunAnnettuRahaSummaOnkinNegatiivinen() {
